...
TEST_F(PolkadotWalletServiceUnitTest, ValidateAddressForTransaction) {
  ...
  {
    base::test::TestFuture<mojom::PolkadotAddresError> future;
    polkadot_wallet_service->ValidateAddressForTransaction(
        mojom::kPolkadotMainnet,
        "158HHeYTmEXMiMM1XufQt5bEe2CTia3EcVcfrpYBYcXA6bdb",
        future.GetCallback());
    EXPECT_EQ(future.Get(), mojom::PolkadotAddresError::kNoError);
  }

  {
    ...
    polkadot_wallet_service->ValidateAddressForTransaction(
        ...
        future.GetCallback());
    EXPECT_EQ(future.Get(), mojom::PolkadotAddresError::kInvalidPrefix);
  }

  {
    ...
    EXPECT_EQ(future.Get(), mojom::PolkadotAddresError::kInvalidAddressFormat);
  }
}
